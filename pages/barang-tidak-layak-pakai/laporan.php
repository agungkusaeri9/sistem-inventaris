...
<section class="section">
    <div class="section-header">
        <h1>Laporan Barang Tidak Layak Pakai</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?= BASE_URL . '/main.php?page=dashboard' ?>">Dashboard</a>
            </div>
            <div class="breadcrumb-item">Laporan Barang Tidak Layak Pakai</div>
        </div>
    </div>
    <div class="section-body">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= BASE_URL . '/pages/barang-tidak-layak-pakai/cetak-pdf.php' ?>" method="post">
