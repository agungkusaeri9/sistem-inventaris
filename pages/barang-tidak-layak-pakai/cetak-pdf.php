...
$items = getDataBarangTidakLayakPakaiFilter($filter);
...
<head>
    ...
    <title>Laporan Barang Tidak Layak Pakai</title>
    <style>
        body {
            font-size: 12px;
        }
...
<body>
    <h2 style="text-align: center">Laporan Barang Tidak Layak Pakai</h2>
    <table class="tb-info">';
...
$dompdf->stream("laporan-barang-tidak-layak-pakai.pdf", ["Attachment" => true]);
