...
if (isset($_POST['delete'])) {
    ...
    redirectUrl(BASE_URL . '/main.php?page=barang-tidak-layak-pakai&status=success&message=Barang Rusak berhasil dihapus!');
}

?>
<section class="section">
    <div class="section-header">
        <h1>Data Barang Tidak Layak Pakai</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?= BASE_URL . '/main.php?page=dashboard' ?>">Dashboard</a>
            </div>
            <div class="breadcrumb-item">Data Barang Tidak Layak Pakai</div>
        </div>
    </div>
    <div class="section-body">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <a href="<?= BASE_URL . '/main.php?page=barang-tidak-layak-pakai-create' ?>" class="btn btn-sm btn-primary mb-3 btnAdd"><i class="fas fa-plus"></i> Tambah Data</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($items as $item) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= BASE_URL . '/main.php?page=barang-tidak-layak-pakai-edit&id_barang_rusak=' . $item['id_barang_rusak'] ?>" class="btn btn-info"><i class="fas fa-edit"></i> Edit</a>
