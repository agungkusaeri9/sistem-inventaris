...
if (!$item)
    redirectUrl(BASE_URL . '/main.php?page=barang-tidak-layak-pakai');

if (isset($_POST['update'])) {
    validasiEdit($_POST);
    $update = updateData($_POST);
    if ($update) {
        redirectUrl(BASE_URL . '/main.php?page=barang-tidak-layak-pakai&status=success&message=Barang Rusak berhasil diupdate!');
    } else {
        redirectUrl(BASE_URL . '/main.php?page=barang-tidak-layak-pakai&status=error&message=Barang Rusak gagal diupdate!');
    }
}
...
<section class="section">
    <div class="section-header">
        <h1>Edit Barang Tidak Layak Pakai</h1>
        <div class="section-header-breadcrumb">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Edit Barang Tidak Layak Pakai</div>
            </div>
        </div>
    </div>
